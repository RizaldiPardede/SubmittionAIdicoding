...
import com.example.submissionpertamaai.utils.DataDummy
import com.example.submissionpertamaai.utils.MainDispatcherRule
import com.example.submissionpertamaai.utils.getOrAwaitValue
...
class PagingViewModelTest{
    ...
    fun `when getStory Should Not Null and Return Success`() = runTest {
        ...
        val listStoryViewModel = PagingViewModel(storyRepository)
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        val listStoryViewModel = PagingViewModel(storyRepository)
        val actualQuote: PagingData<ListStoryItem> = listStoryViewModel.story.getOrAwaitValue()
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoryListAdapter.DIFF_CALLBACK,
            updateCallback = noopListUpdateCallback,
            workerDispatcher = Dispatchers.Main,
